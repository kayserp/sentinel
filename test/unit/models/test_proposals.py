...
def go_list_proposals():
    items = [
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "dean-miller-5493", "payment_address": "yYe8KwyaUu5YswSYmB3q3ryx8XTUu9y7Ui", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://iqcashcentral.org/dean-miller-5493"}]]',
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "yYe8KwyaUu5YswSYmB3q3ryx8XTUu9y7Ui", "payment_amount": 25.75, "start_epoch": 1474261086, "type": 1, "url": "http://iqcashcentral.org/fernandez-7625"}]]',
...
def proposal():
    ...
    pobj = Proposal(
        ...
        url="https://iqcashcentral.com/wine-n-cheeze-party",
...
def test_proposal_is_valid(proposal):
    ...
    # this is actually the IQcash foundation multisig address...
    ...
    # ============================================================
    # ensure proposal can't request negative iqcash
    # ============================================================
...
def test_approved_and_ranked(go_list_proposals):
    ...
    for item in go_list_proposals:
        (go, subobj) = GovernanceObject.import_gobject_from_iqcashd(iqcashd, item)
