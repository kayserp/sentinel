...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to iqcashd "gobject list" output
    ...
    def iqcashd_serialise(self):
        import iqcashlib
        return iqcashlib.SHIM_serialise_for_iqcashd(self.serialise())
